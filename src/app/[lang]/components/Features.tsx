  ...
  return (
    <div className="flex flex-col items-center p-4">
      <svg
        ...
        viewBox="0 0 20 20"
        fill="currentColor"
        className="w-8 h-8 dark:text-white-400"
      >
        <path
          fillRule="evenodd"
      ...
      {showLink && url && text && (
        <div>
          <Link
            ...
            className="inline-block px-4 py-2 mt-4 text-sm font-semibold text-white transition duration-200 ease-in-out bg-sanaat-red rounded-lg hover:bg-sanaat-red"
          >
            {text}
          </Link>
        </div>
