...
function selectedFilter(current: string, selected: string) {
  return current === selected
    ? "px-3 py-1 rounded-lg hover:underline dark:sanaat-red dark:text-gray-100"
    : "px-3 py-1 rounded-lg hover:underline dark:sanaat-red dark:text-gray-900";
}
              ...
              return (
                <li>
                  <Link
                    ...
                    className={`${
                      params.slug === article.attributes.slug && "text-white-400"
                    }  hover:underline hover:text-white-400 transition-colors duration-200`}
                  >
